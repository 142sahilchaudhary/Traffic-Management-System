...
Flask is used to create backend APIs.
...
This connects Python with MySQL database.
...
This starts Flask backend server.
...
This starts AI vehicle detection system.
...
Developed an AI-powered Traffic Management System using Python Flask, OpenCV, YOLO, MySQL, and Machine Learning. The system performs real-time vehicle detection, traffic congestion analysis, and dynamic signal control for efficient traffic flow management.
